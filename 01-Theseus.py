...
st.header("1. How Theseus got his first Minotauring job.")
st.image("img/01-Theseus.webp", use_container_width=True)
st.write("> **Как Тесей получил свою первую работу с минотаврами.**")
st.write("""
...
with col3:
    st.html('<div style="text-align: center"><a href="/t"><img src="app/static/02-T-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
