...
st.header("3. I hate to blame Dædalus for everything")
st.image("img/03-Blame.webp", use_container_width=True)
st.write("> **Конечно не хотелось бы во всём винить Дедала**")
st.write("""
but a lot of the present complication was his fault. 
...
with col1:
    st.html('<div style="text-align: center"><a href="/t"><img src="app/static/02-T-thumb.png" width=200><br><img src="app/static/sword-left.png" width=200></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" width=250></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/daedalus"><img src="app/static/04-Daedalus-thumb.png" width=200><br><img src="app/static/sword-right.png" width=200></a></div>')    
