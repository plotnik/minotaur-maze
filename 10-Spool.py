...
st.header("10. The Spool of Thread.")
st.image("img/10-Spool.webp", use_container_width=True)
st.write("> **Клубок ниток**")
st.write("""
...
with col1:
    st.html('<div style="text-align: center"><a href="/world"><img src="app/static/09-Maze-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-left.png" class="responsive-img-200"></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" class="responsive-img-250"></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/theobombus"><img src="app/static/11-Theobombus-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
