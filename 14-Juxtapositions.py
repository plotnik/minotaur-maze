...
st.header("14. In the Maze of Juxtapositions.")
st.image("img/14-Juxtapositions.webp", use_container_width=True)
st.write("> **В Лабиринте Противоположностей**")
st.write("""
...
with col1:
    st.html('<div style="text-align: center"><a href="/knossos"><img src="app/static/13-Knossos-thumb.png" width=200><br><img src="app/static/sword-left.png" width=200></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" width=250></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/unicorn"><img src="app/static/15-Unicorn-thumb.png" width=200><br><img src="app/static/sword-right.png" width=200></a></div>')    
