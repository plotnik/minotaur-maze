...
st.header("15. Sorrows of the Minotaur.")
st.image("img/15-Unicorn.webp", use_container_width=True)
st.write("> **Печали Минотавра**")
st.write("""
...
with col1:
    st.html('<div style="text-align: center"><a href="/juxtapositions"><img src="app/static/14-Juxtapositions-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-left.png" class="responsive-img-200"></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" class="responsive-img-250"></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/theory"><img src="app/static/16-Daedalus-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
