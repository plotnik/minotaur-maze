...
st.header("16. Although Minos is king, Dædalus")
st.image("img/16-Daedalus.webp", use_container_width=True)
st.write("> **Хоть Минос и царь, но Дедал**")
st.write("""
...
with col1:
    st.html('<div style="text-align: center"><a href="/unicorn"><img src="app/static/15-Unicorn-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-left.png" class="responsive-img-200"></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" class="responsive-img-250"></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/hornectomy"><img src="app/static/17-Hornectomy-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
