...
st.header("19. The Profit Motive.")
st.image("img/19-Profit.webp", use_container_width=True)
st.write("> **Корыстные мотивы**")
st.write("""
...
with col1:
    st.html('<div style="text-align: center"><a href="/touch"><img src="app/static/18-Midas-thumb.png" width=200><br><img src="app/static/sword-left.png" width=200></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" width=250></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/selfpity"><img src="app/static/20-Self-Pity-Plant-thumb.png" width=200><br><img src="app/static/sword-right.png" width=200></a></div>')    
