...
st.header("21. Minotaur & Midas.")
st.image("img/21-Minotaur-Midas.webp", use_container_width=True)
st.write("> **Минотавр и Мидас**")
st.write("""
...
> Мидас так долго говорил о неприятных ограничениях, которые стесняли его и лишали возможности предоставлять займы, что Минотавр начал испытывать к нему жалость. Бедный несчастный царь со всеми своими невероятными сокровищами, с его золотым прикосновением и высшим кредитным рейтингом, не в состоянии помочь делам, наиболее близким его сердцу.
...
with col1:
    st.html('<div style="text-align: center"><a href="/selfpity"><img src="app/static/20-Self-Pity-Plant-thumb.png" width=200><br><img src="app/static/sword-left.png" width=200></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" width=250></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/causality"><img src="app/static/22-Causality-thumb.png" width=200><br><img src="app/static/sword-right.png" width=200></a></div>')    
