...
st.header("24. Minotaur Meets Minerva.")
st.image("img/24-Minerva.webp", use_container_width=True)
st.write("> **Минотавр встречает Минерву**")
st.write("""
...
with col1:
    st.html('<div style="text-align: center"><a href="/chinese"><img src="app/static/23-Chinese-Waiter-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-left.png" class="responsive-img-200"></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" class="responsive-img-250"></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/alien"><img src="app/static/25-Alien-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
