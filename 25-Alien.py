...
st.header("25. The Alien Observer.")
st.image("img/25-Alien.webp", use_container_width=True)
st.write("> **Инопланетный Агент**")
st.write("""
...
> "Однако я чудовище," заметил Минотавр, полагая, что пришелец со своими непостижимыми способами восприятия мог этого не заметить.
...
> «Как такое возможно?» — спросил Минотавр.
...
with col1:
    st.html('<div style="text-align: center"><a href="/minerva"><img src="app/static/24-Minerva-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-left.png" class="responsive-img-200"></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" class="responsive-img-250"></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/telephone"><img src="app/static/26-Telephone-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
