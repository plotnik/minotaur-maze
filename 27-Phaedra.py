...
st.header("27. Girl Named Phædra.")
st.image("img/27-Phaedra.webp", use_container_width=True)
st.write("> **Девушка по имени Федра**")
st.write("""
...
> Тесей думает, что легенда о Федре — один из трюков Дедала, предлагающий альтернативу, которую ты не принимаешь, потому что она выглядит плохо, хотя на самом деле все могло бы сложиться очень хорошо. Именно так Дедал усложняет свой лабиринт.
...
> «Надеюсь, — говорит Минотавр, — ты не бежал по этим пяти пролетам.»
...
> «Тесей, ты хитрый эллинский ублюдок, но я почти могу тебя пожалеть. Почти, но не совсем. Закон конфликта запрещает мне приглашать тебя на вечеринку.»
...
with col1:
    st.html('<div style="text-align: center"><a href="/telephone"><img src="app/static/26-Telephone-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-left.png" class="responsive-img-200"></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" class="responsive-img-250"></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/reclination"><img src="app/static/28-Reclination-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
