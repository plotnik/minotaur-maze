...
with col1:
    st.html('<div style="text-align: center"><a href="/reclination"><img src="app/static/28-Reclination-thumb.png" width=200><br><img src="app/static/sword-left.png" width=200></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" width=250></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/falling"><img src="app/static/30-Falling-thumb.png" width=200><br><img src="app/static/sword-right.png" width=200></a></div>')    
