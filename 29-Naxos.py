...
st.header("29. Phone Call to Naxos.")
st.image("img/29-Naxos.webp", use_container_width=True)
st.write("> **Звонок на Наксос**")
st.write("""
...
with col1:
    st.html('<div style="text-align: center"><a href="/reclination"><img src="app/static/28-Reclination-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-left.png" class="responsive-img-200"></a></div>')  

with col2:
    st.html('<div style="text-align: center"><a href="/"><img src="app/static/00-Minotaur-thumb.png" class="responsive-img-250"></a></div>')  

with col3:
    st.html('<div style="text-align: center"><a href="/falling"><img src="app/static/30-Falling-thumb.png" class="responsive-img-200"><br><img src="app/static/sword-right.png" class="responsive-img-200"></a></div>')    
