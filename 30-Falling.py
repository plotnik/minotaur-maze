...
st.header("30. Falling Through the Story.")
st.image("img/30-Falling.webp", use_container_width=True)
st.write("> **Провалившись в историю**")
st.write("""
...
<div class="flex-column">
    <a href="/naxos">
        <img class="responsive-img-200" src="app/static/29-Naxos-thumb.png"><br>
